Funcion reservarTurno = agendarTurno(agendaVacunatorio, stockVacunas, vacunas, pacientesListado, dim Por Referencia, turnosOtorgados Por Referencia)
	...
	Escribir "Ingrese el número de la vacuna:"
...
Proceso vacunatorio
	...
	Mientras opcionMenu <> 6 Hacer
		...
		Mientras opcionMenu < 1 o opcionMenu > 6 Hacer
			Escribir "Error: seleccione una opcion válida."
		FinMientras
		Leer opcionMenu
		...
		FinSegun
	fin mientras
	Escribir "Muchas gracias por utilizar el Sistema de Gestión de Turnos para el Vacunatorio - Hospital de Niños Dr. Victor J. Vilela"
FinProceso
...
Funcion buscarPaciente <- busquedaDni(DNI, pacientesListado, dim)
	...
	Mientras i <= dim-1 Hacer
		si pacientesListado[i,2] == DNI Entonces
			Escribir "Se encontró el paciente."
	...
	si bandera = Falso Entonces
		Escribir "No se encontró el paciente."
	FinSi
FinFuncion
